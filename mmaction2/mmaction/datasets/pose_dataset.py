...
class PoseDataset(BaseActionDataset):
    ...
    def load_data_list(self) -> List[Dict]:
        ...
        if self.split is not None:
            ...
            #判断x存在
            data_list = [x for x in annos if x is not None and isinstance(x, dict) and identifier in x and x[identifier] in split]
    ...
    def filter_data(self) -> List[Dict]:
        ...
        if self.valid_ratio is not None and isinstance(
            ...
            print("self.valid_ratio:", self.valid_ratio)
            print("self.box_thr:", self.box_thr)
